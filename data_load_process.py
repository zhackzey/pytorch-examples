...
class Rescale(object):
    '''
        rescale sample images to given size
        Args:
            output_size (tuple or int): needed output size 
            if tuple, output size matches output_size
            if int,   match smaller image border to output_size while keep HW ratio
    '''
...
class RandomCrop(object):
    '''
        Randomly crop sample images to given size
        Args:
...
# apply each transform to samples 
fig = plt.figure()
